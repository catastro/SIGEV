...
/**
 * TMenuRol generated by hbm2java
 */
public class TMenuRol  implements java.io.Serializable {
    ...
    public TMenuRol(int idmenurol) {
        this.idmenurol = idmenurol;
    }
    public TMenuRol(int idmenurol, TMenu TMenu, TRol TRol, String estado, String observacion, Integer idusuariocreac, Integer idusuariomodif, Date fechacreac, Date fechamodif) {
       this.idmenurol = idmenurol;
       this.TMenu = TMenu;
       this.TRol = TRol;
       this.estado = estado;
