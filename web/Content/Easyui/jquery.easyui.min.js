...
(function ($) {
    $.parser = {auto: true, onComplete: function (_1) {
        }, plugins: ["draggable", "droppable", "resizable", "pagination", "tooltip", "linkbutton", "menu", "menubutton", "splitbutton", "progressbar", "tree", "textbox", "filebox", "combo", "combobox", "combotree", "combogrid", "numberbox", "validatebox", "searchbox", "spinner", "numberspinner", "timespinner", "datetimespinner", "calendar", "datebox", "datetimebox", "slider", "layout", "panel", "datagrid", "propertygrid", "treegrid", "tabs", "accordion", "window", "dialog_", "form"], parse: function (_2) {
            var aa = [];
...
(function ($) {
    function _27f(_280) {
        var opts = $.data(_280, "dialog_").options;
        opts.inited = false;
        ...
        if (opts.toolbar) {
            if ($.isArray(opts.toolbar)) {
                $(_280).siblings("div.dialog_-toolbar").remove();
                var _281 = $("<div class=\"dialog_-toolbar\"><table cellspacing=\"0\" cellpadding=\"0\"><tr></tr></table></div>").appendTo(win);
                var tr = _281.find("tr");
                for (var i = 0; i < opts.toolbar.length; i++) {
                    var btn = opts.toolbar[i];
                    if (btn == "-") {
                        $("<td><div class=\"dialog_-tool-separator\"></div></td>").appendTo(tr);
                    } else {
                        var td = $("<td></td>").appendTo(tr);
                ...
                $(opts.toolbar).addClass("dialog_-toolbar").appendTo(win);
                $(opts.toolbar).show();
            }
        } else {
            $(_280).siblings("div.dialog_-toolbar").remove();
        ...
        if (opts.buttons) {
            if ($.isArray(opts.buttons)) {
                $(_280).siblings("div.dialog_-button").remove();
                var _282 = $("<div class=\"dialog_-button\"></div>").appendTo(win);
                ...
                $(opts.buttons).addClass("dialog_-button").appendTo(win);
                $(opts.buttons).show();
            }
        } else {
            $(_280).siblings("div.dialog_-button").remove();
    ...
    function _284(_285, _286) {
        var t = $(_285);
        var opts = t.dialog_("options");
        var _287 = opts.noheader;
        var tb = t.siblings(".dialog_-toolbar");
        var bb = t.siblings(".dialog_-button");
    ...
    ;
    $.fn.dialog_ = function (_289, _28a) {
        if (typeof _289 == "string") {
            var _28b = $.fn.dialog_.methods[_289];
            if (_28b) {
        ...
        _289 = _289 || {};
        return this.each(function () {
            var _28c = $.data(this, "dialog_");
            if (_28c) {
                $.extend(_28c.options, _289);
            } else {
                $.data(this, "dialog_", {options: $.extend({}, $.fn.dialog_.defaults, $.fn.dialog_.parseOptions(this), _289)});
            }
            _27f(this);
        });
    };
    $.fn.dialog_.methods = {options: function (jq) {
            var _28d = $.data(jq[0], "dialog_").options;
    ...
    $.fn.dialog_.parseOptions = function (_28f) {
        return $.extend({}, $.fn.window.parseOptions(_28f), $.parser.parseOptions(_28f, ["toolbar", "buttons"]));
    };
    $.fn.dialog_.defaults = $.extend({}, $.fn.window.defaults, {title: "New Dialog", collapsible: false, minimizable: false, maximizable: false, resizable: false, toolbar: null, buttons: null});
})(jQuery);
(function ($) {
